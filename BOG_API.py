...
COMPANY_CREDENTIALS_BOG = {
    'RGG': {'client_id': '633822f9-a298-49e0-9545-97b78e4d9b04', 'client_secret': 'fb73a373-d464-4052-b9a4-2fee0a83c9e3'},
    'MRG': {'client_id': 'e86520fd-3861-40fb-841e-3a90cc9ae35f', 'client_secret': '67c7d183-e133-4741-8496-5745b94f2de4'},
    'SRG': {'client_id': '8f53ad44-9cfc-4f3d-a28c-ca0ba4867b88', 'client_secret': 'ef024a17-44a0-4103-b3c6-5787a291da0b'},
    'PRG': {'client_id': 'd6749fac-3fe7-4840-99fa-dd7a55eb311f', 'client_secret': 'ebc950f3-d613-40dd-b93a-6790300bfabd'},
    'MHR': {'client_id': 'fc232347-1f78-40a2-8891-796c9108e8ee', 'client_secret': 'fd121084-7f54-4af2-941b-a53205f88af5'},
    'RGH': {'client_id': 'e68cb474-6574-4f9c-9910-27284092627d', 'client_secret': '769009c4-886a-4793-9b9d-a1945ea38e81'},
    'MSG': {'client_id': '36de8978-c8e4-48c2-aa9a-023071c42a40', 'client_secret': '76979b9e-0f86-48da-9d8e-bfbf4d7ffacd'},
    'FRG': {'client_id': '7910185a-bef6-4fab-80e2-529953814eef', 'client_secret': '1b3da861-8a75-42fa-810a-769ac93a6463'},
    'BRG': {'client_id': 'c27815b4-0c91-4d13-a9ed-d4f403adf1b7', 'client_secret': '1d666108-2fcd-4a56-b30d-542fede107b5'},
}
...
def fetch_transactions_for_account(client_id, client_secret, account_number, currency, start_date, end_date, company=None):
...
if __name__ == '__main__':
    ...
    df.to_excel('bog_transactions.xlsx', index=False)
    print(df.head())
